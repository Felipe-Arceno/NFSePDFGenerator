...
{
    public static class MunicipioHelper
    {
        private static readonly Dictionary<string, (string Nome, string UF)> _municipios = new Dictionary<string, (string Nome, string UF)>
        {
            // Auto-generated from Cidades.csv and Estados.csv
            ...
            { "5200258", ("Águas Lindas de Goiás", "DF") },
            { "5200308", ("Alexânia", "GO") },
            { "5200506", ("Aloândia", "GO") },
            { "5200555", ("Alto Horizonte", "GO") },
            { "5200605", ("Alto Paraíso de Goiás", "DF") },
            ...
            { "5204904", ("Campos Belos", "DF") },
            { "5204953", ("Campos Verdes", "GO") },
            { "5205000", ("Carmo do Rio Verde", "GO") },
            { "5205059", ("Castelândia", "GO") },
            { "5205109", ("Catalão", "GO") },
            { "5205208", ("Caturaí", "GO") },
            { "5205307", ("Cavalcante", "DF") },
            { "5205406", ("Ceres", "GO") },
            { "5205455", ("Cezarina", "GO") },
            { "5205471", ("Chapadão do Céu", "GO") },
            { "5205497", ("Cidade Ocidental", "DF") },
            { "5205513", ("Cocalzinho de Goiás", "DF") },
            ...
            { "5219753", ("Santo Antônio do Descoberto", "DF") },
            ...
            { "5221700", ("Uruana", "GO") },
            { "5221809", ("Urutaí", "GO") },
            { "5221858", ("Valparaíso de Goiás", "DF") },
            { "5221908", ("Varjão", "GO") },
        ...
        public static string GetMunicipioNome(string codigoIbge)
        {
            if (string.IsNullOrWhiteSpace(codigoIbge)) return "-";
            if (_municipios.TryGetValue(codigoIbge.Trim(), out var mun))
            {
                return $"{mun.Nome} - {mun.UF}";
            }
            return codigoIbge;
        }

        public static string GetMunicipioNomeOnly(string codigoIbge)
        {
            if (string.IsNullOrWhiteSpace(codigoIbge)) return "-";
            if (_municipios.TryGetValue(codigoIbge.Trim(), out var mun))
            {
        ...
        public static string GetUF(string codigoIbge)
        {
            if (string.IsNullOrWhiteSpace(codigoIbge)) return "-";
            if (_municipios.TryGetValue(codigoIbge.Trim(), out var mun))
            {
